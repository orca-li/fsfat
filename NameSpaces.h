...
#define STRUCT_ID_NUMFATS_OFFSET     (STRUCT_ID_RSVDSECCNT_OFFSET + STRUCT_ID_RSVDSECCNT_SZ)

#define STRUCT_ID_ROOTENTCNT_NAME     RootEntCnt
#define STRUCT_ID_ROOTENTCNT_IDX      (STRUCT_ID_NUMFATS_OFFSET)
#define STRUCT_ID_ROOTENTCNT_SZ       (1)
...
#define STRUCT_ID_TOTSEC16_IDX        (STRUCT_ID_NUMFATS_OFFSET)
#define STRUCT_ID_TOTSEC16_SZ         (1)
#define STRUCT_ID_TOTSEC16_OFFSET     (STRUCT_ID_NUMFATS_OFFSET + STRUCT_ID_ROOTENTCNT_SZ)

#define STRUCT_ID_MEDIA_NAME          Media
#define STRUCT_ID_MEDIA_IDX           (STRUCT_ID_TOTSEC16_OFFSET)
#define STRUCT_ID_MEDIA_SZ            (1)
#define STRUCT_ID_MEDIA_OFFSET        (STRUCT_ID_TOTSEC16_OFFSET + STRUCT_ID_TOTSEC16_SZ)

#define STRUCT_ID_FATSZ16_NAME        FATSz16
#define STRUCT_ID_FATSZ16_IDX         (STRUCT_ID_MEDIA_OFFSET)
#define STRUCT_ID_FATSZ16_SZ          (1)
...
#define STRUCT_ID_SECPERTRK_SZ        (1)
...
#define STRUCT_ID_NUMHEADS_SZ         (1)
...
#define STRUCT_ID_HIDDSEC_SZ          (1)
#define STRUCT_ID_HIDDSEC_OFFSET      (STRUCT_ID_NUMHEADS_OFFSET + STRUCT_ID_HIDDSEC_SZ)

#define STRUCT_ID_TOTSEC32_NAME       TotSec32
#define STRUCT_ID_TOTSEC32_IDX        (STRUCT_ID_NUMHEADS_OFFSET)
#define STRUCT_ID_TOTSEC32_SZ         (1)
#define STRUCT_ID_TOTSEC32_OFFSET     (STRUCT_ID_NUMHEADS_OFFSET + STRUCT_ID_TOTSEC32_SZ)
...
#define STRUCT_ID_EXTFLAGS_SZ         (1)
#define STRUCT_ID_EXTFLAGS_OFFSET     (STRUCT_ID_FATSZ32_OFFSET + STRUCT_ID_EXTFLAGS_SZ)

#define STRUCT_ID_FSVER_NAME          FSVer
#define STRUCT_ID_FSVER_IDX           (STRUCT_ID_TOTSEC32_OFFSET)
#define STRUCT_ID_FSVER_SZ            (1)
#define STRUCT_ID_FSVER_OFFSET        (STRUCT_ID_TOTSEC32_OFFSET + STRUCT_ID_FATSZ32_SZ)

#define STRUCT_ID_ROOTCLUS_NAME       RootClus
#define STRUCT_ID_ROOTCLUS_IDX        (STRUCT_ID_TOTSEC32_OFFSET)
#define STRUCT_ID_ROOTCLUS_SZ         (1)
#define STRUCT_ID_ROOTCLUS_OFFSET     (STRUCT_ID_TOTSEC32_OFFSET + STRUCT_ID_FATSZ32_SZ)

#define STRUCT_ID_FSINFO_NAME         FSInfo
#define STRUCT_ID_FSINFO_IDX          (STRUCT_ID_TOTSEC32_OFFSET)
#define STRUCT_ID_FSINFO_SZ           (1)
#define STRUCT_ID_FSINFO_OFFSET       (STRUCT_ID_TOTSEC32_OFFSET + STRUCT_ID_FATSZ32_SZ)

#define STRUCT_ID_BKBOOTSEC_NAME      BkBootSec
#define STRUCT_ID_BKBOOTSEC_IDX       (STRUCT_ID_TOTSEC32_OFFSET)
#define STRUCT_ID_BKBOOTSEC_SZ        (1)
#define STRUCT_ID_BKBOOTSEC_OFFSET    (STRUCT_ID_TOTSEC32_OFFSET + STRUCT_ID_FATSZ32_SZ)

#define STRUCT_ID_RESERVED0_NAME      Reserved
#define STRUCT_ID_RESERVED0_IDX       (STRUCT_ID_TOTSEC32_OFFSET)
#define STRUCT_ID_RESERVED0_SZ        (1)
#define STRUCT_ID_RESERVED0_OFFSET    (STRUCT_ID_TOTSEC32_OFFSET + STRUCT_ID_FATSZ32_SZ)
...
#define STRUCT_ID_RESERVED1_IDX       (STRUCT_ID_TOTSEC32_OFFSET)
#define STRUCT_ID_RESERVED1_SZ        (1)
#define STRUCT_ID_RESERVED1_OFFSET    (STRUCT_ID_TOTSEC32_OFFSET + STRUCT_ID_FATSZ32_SZ)

#define STRUCT_ID_BOOTSIG_NAME        BootSig
#define STRUCT_ID_BOOTSIG_IDX         (STRUCT_ID_TOTSEC32_OFFSET)
#define STRUCT_ID_BOOTSIG_SZ          (1)
#define STRUCT_ID_BOOTSIG_OFFSET      (STRUCT_ID_TOTSEC32_OFFSET + STRUCT_ID_FATSZ32_SZ)
